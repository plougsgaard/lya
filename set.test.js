...
describe('set nested (new) key', () => {
  test('result has the nested key', () => {
    let source = { a: { q: 32 } }
    let target = set('a.b.c', 42, source)
...
describe('negative cases', () => {
  test('should remain unchanged', () => {
    expect(set('0', 123, [])).toEqual([])
    expect(set('0', 123, null)).toEqual(null)
    expect(set('0', 123, undefined)).toEqual(undefined)
  })
})
